            ...
            <div class="cards--bookmoc">
                ...
                <div class="cards__content">
                    ...
                    <div class="cards__content__buttons CARD_BUTTONS_CONTAINER">
                        ...
                        <button class="cards__content__buttons--add Mybtn ADD_TO_LIBRARY_BTN" data-book-id="${book.id}">افزودن به کتابخانه</button>
                        
                        <i class="fa-regular fa-heart cards__content__buttons--fav MyIcon ADD_TO_FAV_BTN" data-fav-book="${book.id}"></i>
